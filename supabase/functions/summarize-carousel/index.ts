        ...
        tools: [
          {
            ...
            function: {
              ...
              parameters: {
                type: "object",
                properties: {
                  hook: { type: "string", description: "Panel 1. 1-2 sentences. A pattern interrupt or quiet observation that makes a planner stop scrolling." },
                  blindSpot: { type: "string", description: "Panel 2. 2-4 sentences. The thing most people in the category miss, explained with enough room to actually land." },
                  reframe: { type: "string", description: "Panel 3. 1-3 sentences. The shift in thinking the article offers, quotable but allowed to breathe." },
                  proof: { type: "string", description: "Panel 4. 2-4 sentences. Concrete evidence, example, or principle from the article. Use real specifics from the body." },
                  proofCred: { type: "string", description: "Optional short credibility line for Panel 4. One short line. Can be empty." },
                  ctaQuestion: { type: "string", description: "Panel 5. 1-2 sentences. A question that invites a reply or click without sounding salesy." },
                },
