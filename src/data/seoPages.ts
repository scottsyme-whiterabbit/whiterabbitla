...
const citySpecificOverrides: Record<string, string[]> = {
  ...
  "new-york--corporate-event-magician": [
    "New York's corporate event world operates at a level where entertainment has to match the stakes and the sophistication of the room. Scott Syme has performed at countless events across Manhattan for financial firms, media companies, and fashion industry leaders who expect excellence without compromise. Close-up magic at a private dinner in a club that doesn't advertise its address, or working a financial services gala where every interaction matters, requires the kind of skill and presence that Scott brings to every event.",
    "Manhattan's corporate life is built on relationships and reputation, and when Scott performs at your event, whether it's a holiday party for a media company, an investor dinner in Midtown, or an intimate gathering at a Financial District private club. He becomes part of that relationship-building moment. His magic doesn't distract from business; it enhances it, creating genuine moments of connection that people remember and talk about with colleagues for years. In a city where everyone has seen everything, Scott's close-up magic hits different because it's real skill, real presence, and real magic.",
  ],
  ...
  "las-vegas--corporate-event-magician": [
    "Las Vegas, the city built on illusion and spectacle. When corporate events happen here at the Venetian Expo, Wynn, or Bellagio, or when companies host high-roller suite private parties and Red Rock Canyon retreats, they don't want stage magic or production tricks. They want close-up magic performed by someone with genuine skill, the kind that Scott Syme delivers, magic that works in intimate settings, that reads the room perfectly, that creates real moments of surprise and wonder. Las Vegas audiences are sophisticated about magic, and they appreciate the difference between performance and genuine sleight of hand.",
    "Scott's background includes membership in the Magic Castle in Hollywood, which means his approach to magic is grounded in real skill and the kind of precision that appeals to Vegas corporate event crowds. Whether it's a formal corporate dinner at Aria, a private event at Shadow Creek, or an intimate gathering in a suite overlooking the Strip, his magic works because it doesn't rely on spectacle. It relies on genuine ability and reading the room. Your guests will recognize the difference between typical event entertainment and a real magician doing real magic, and that distinction matters in Las Vegas more than anywhere else.",
  ],
  ...
  "chicago--corporate-event-magician": [
    "Chicago's corporate culture values substance over flash, which is exactly why Scott Syme's approach to close-up magic resonates here. The Langham, Peninsula Chicago, and Gibson's private dining rooms host events for companies that won't settle for anything less than genuine skill and authentic presence. When Midwestern corporate culture meets a magician who doesn't oversell himself and doesn't rely on flash, something real happens: your guests actually remember the interaction, the moment of genuine surprise, the conversation that sparked from a single magical moment at their table.",
    "Gold Coast mansions and Lincoln Park townhouses set the stage for Chicago's most exclusive corporate gatherings, dinners that matter, investor meetings that shape companies, team offsites for executives who've built real wealth. Scott performs regularly in Chicago, as comfortable working McCormick Place trade shows as he is in intimate settings at Alinea or a private mansion. He reads the room with the precision Chicago business culture demands, delivers results without the corporate-event cliches, and leaves a lasting impression that extends well beyond the evening itself.",
  ],
  ...
  "dallas--corporate-event-magician": [
    "Dallas corporate events embody Texas hospitality and a go-big mentality that demands entertainment matching the scale and confidence of the room. Oil and gas money, finance, and the wave of tech companies moving to DFW all host events in Highland Park estates, Preston Hollow mansions, and Uptown venues where expectations are high and budgets match. Scott Syme flies in from Los Angeles to perform at these significant gatherings, bringing the same precision and polish he delivers in Beverly Hills and New York. Dallas business culture appreciates confidence without arrogance, and that's exactly what White Rabbit magic delivers.",
    "Whether your event is in the Arts District, the Design District, or a private estate in one of Dallas's most exclusive neighborhoods, Scott reads the room with the kind of directness Dallas corporate culture demands. Close-up magic works beautifully at these events because it creates intimate moments of genuine surprise in the midst of high-level networking and celebration. Your guests won't just remember the magic; they'll remember Scott, the professional who understood the room, performed with precision, and created moments worth talking about long after the event ends.",
  ],
  ...
  "houston--corporate-event-magician": [
    "Houston's corporate event scene spans industries and scales, from River Oaks and Memorial estates to the Galleria area corporate galas and massive medical center conferences. When international business leaders and Houston's oil and gas elite gather at venues throughout the city, they expect entertainment that matches the global sophistication of the room. Scott Syme flies in from Los Angeles to perform at these high-level events, working everything from formal dinners to private suite receptions where genuine connection and memorable moments matter more than production spectacle.",
    "The medical center conference scene in Houston is unlike anywhere else, and Scott has performed for healthcare industry leaders, international business delegations, and corporate teams where the audience spans cultures and backgrounds. Close-up magic at these events creates genuine moments of wonder that resonate across business divides. Whether it's a George R. Brown Convention Center gala, a Museum District private event, or an intimate dinner for executives reshaping the energy industry, White Rabbit magic creates the kind of authentic entertainment experience that builds relationships and leaves a lasting impression.",
  ],
  ...
  "atlanta--corporate-event-magician": [
    "Atlanta's corporate scene is powered by companies like Coca-Cola, Delta, Home Depot, and UPS, companies that understand quality and have no tolerance for mediocrity in any aspect of their events. Druid Hills and Virginia-Highland estates provide the backdrop for sophisticated gatherings where Southern hospitality meets big-city ambition and resources. Scott Syme flies in from Los Angeles to perform at these significant events, bringing the same level of polish and precision that Atlanta's corporate culture demands. Close-up magic at a corporate dinner or gala for companies of this caliber requires the kind of skill and presence Scott delivers, genuine magic that creates memorable moments without trying too hard.",
    "Atlanta's business community spans traditional Southern wealth, modern tech innovation, and the kind of international business connections that come with being a major hub city. Events at the Georgia World Congress Center, private events near Piedmont Park, gatherings at Ponce City Market. Scott performs across Atlanta's corporate scene with an understanding of the room's dynamics. His magic becomes the conversation starter at networking moments, the highlight of formal dinners, the element that makes your event genuinely memorable. In a city where culture and business move together, White Rabbit magic fits naturally into how Atlanta does things.",
  ],
  ...
  "nashville--corporate-event-magician": [
    "Nashville's corporate scene is where healthcare giants like HCA, a thriving tech startup scene, and the music industry all converge to create events with their own particular energy. The Gulch downtown events, Belle Meade and Green Hills estates, events throughout Music Row and East Nashville all attract executives and business leaders who appreciate authenticity and genuine skill. Scott Syme flies in from Los Angeles to perform at these events, bringing the kind of professionalism that works equally well for a healthcare industry gala or a tech company offsite. Nashville's business culture values Southern charm combined with real ambition and innovation, and that's the exact energy Scott brings to corporate events.",
    "Whether your event celebrates a music industry milestone, hosts an international healthcare conference, or gathers creative entrepreneurs from Nashville's startup scene, Scott's close-up magic creates genuine moments of connection and wonder. The vibe in Nashville is different from coastal cities, there's authenticity here that corporate entertainment needs to match, and Scott understands that. His magic doesn't feel out of place at a CMA Fest industry event or an awards show afterparty; it feels like exactly the right element to create the memorable moments your event needs.",
  ],
  ...
  switch (service.key) {
    ...
    case "wedding-magician":
      ...
      body = [
        ...
        `White Rabbit is based in Los Angeles and travels nationwide for select engagements. Scott travels from Los Angeles to serve couples in ${location}, tailoring each performance to your guest count, timeline, and vision. Cocktail hour roaming magic, a pre-dinner parlor show, or both: whatever your celebration needs to feel complete.`,
