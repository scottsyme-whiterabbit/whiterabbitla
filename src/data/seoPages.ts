...
const citySpecificOverrides: Record<string, string[]> = {
  ...
  "miami--corporate-event-magician": [
    "Miami corporate events have their own energy — waterfront venues, open-air receptions, and a crowd that runs on momentum. Scott flies in from LA for Miami corporate bookings regularly, and the city is one of his most requested travel markets. Close-up magic works at Miami corporate events because the setting is always social — rooftop terraces, poolside cocktail hours, hotel ballrooms with the ocean behind them. The magic matches that energy: fast, sharp, and impossible to ignore.",
    "The Miami corporate crowd is a mix of finance, real estate, hospitality, and Latin American business — people who entertain often and have high standards for how an evening feels. Scott's close-up magic and mentalism cut through the usual cocktail hour small talk because something impossible is happening in their hands. The reactions are big, they're genuine, and they set the tone for the rest of the event.",
  ],
  ...
  "san-francisco--corporate-event-magician": [
    "San Francisco is one of Scott's busiest travel markets for corporate events. Tech companies in SoMa, the Financial District, and South Bay book him for product launches, holiday parties, team offsites, and investor dinners where the entertainment needs to match the caliber of the room. Close-up magic works at these events because the format is social — Scott moves through the cocktail hour performing for small groups, and within minutes, engineers and executives who were checking their phones are laughing together over something they can't explain.",
    "The SF corporate crowd is analytical and skeptical by nature, which makes close-up magic and mentalism land even harder. When someone who builds algorithms for a living watches Scott read their mind and can't reverse-engineer it, the reaction is visceral. That's the moment that turns a corporate cocktail hour into the event people actually talk about at Monday's standup. Scott flies in from LA regularly for San Francisco corporate bookings.",
  ],
