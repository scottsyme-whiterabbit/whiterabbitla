...
const AdminNewsletter = () => {
  ...
  const [activeTab, setActiveTab] = useState<"dashboard" | "pipeline" | "actions" | "revenue" | "contacts" | "compose" | "campaigns" | "calendar" | "analytics" | "email_analytics" | "planner" | "apartment" | "thankyou" | "cold" | "lead_attribution">("dashboard");
    ...
    <div className="min-h-screen bg-background pt-24 pb-16 md:pb-16" onClick={() => searchOpen && setSearchOpen(false)}>
      ...
      <div className={`max-w-6xl mx-auto px-4 md:px-6 ${isMobile ? 'pb-24' : ''}`}>
        ...
        <div className="hidden md:flex gap-1 mb-8 border-b border-border overflow-x-auto">
          {(["dashboard", "pipeline", "actions", "revenue", "contacts", "cold", "compose", "campaigns", "calendar", "analytics", "email_analytics", "lead_attribution", "planner", "apartment", "thankyou"] as const).map(tab => (
            <button
              key={tab}
            ...
            >
              {tab === "actions" ? "ACTION LIST" : tab === "email_analytics" ? "📊 EMAIL ANALYTICS" : tab === "lead_attribution" ? "📈 ATTRIBUTION" : tab === "cold" ? "🎯 OUTREACH" : tab}
          ...
          <div className="fixed inset-0 z-50 bg-background/95 backdrop-blur-sm flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-1">
              {(["dashboard", "pipeline", "actions", "revenue", "contacts", "cold", "compose", "campaigns", "calendar", "analytics", "email_analytics", "lead_attribution", "planner", "apartment", "thankyou"] as const).map(tab => (
                ...
                >
                  {tab === "actions" ? "ACTION LIST" : tab === "email_analytics" ? "📊 Email Analytics" : tab === "lead_attribution" ? "📈 Lead Attribution" : tab === "cold" ? "🎯 Cold Outreach" : tab}
                  {tab === "actions" && actionBadge > 0 && (
