...
const servicePages: Record<string, ServiceData> = {
  ...
  "dmc-entertainment": {
    ...
    faqs: [
      { question: "What is a DMC entertainment partner and how does the booking process work?", answer: "A DMC (destination management company) entertainment partner is a vetted, reservable, repeat-bookable performer that DMCs source for incoming incentive groups, executive offsites, and corporate programs visiting a destination city. White Rabbit LA partners with DMCs operating in Los Angeles for programs sourcing close-up magic and parlor magic for curated LA evenings. The DMC handles the client relationship and booking; Scott Syme delivers the performance to the agreed-upon spec. Insurance, contracts, COIs, and W-9 documentation are pre-loaded for fast turnaround on RFPs." },
      { question: "What types of LA-themed magical experiences can be built into a DMC program?", answer: "Three formats are most commonly requested: (1) a private home or villa close-up performance staged in Beverly Hills, Hollywood Hills, or Malibu venues that DMCs already use, (2) a featured close-up or parlor performance integrated into a curated LA evening (rooftop dinner, classic-Hollywood venue, members' club, private museum buyout), and (3) a bespoke parlor show built around the client's brand, industry, or program theme. Each format is custom-designed to the group." },
      ...
      { question: "What are the standard DMC commercial terms and documentation?", answer: "White Rabbit LA carries $1M general liability insurance on every booking and provides a standard one-page rider, COI naming the venue within 24 hours of request, W-9, and 1099-ready invoicing. Bookings are secured with a 50% deposit and the balance due before the event. Multi-program annual agreements are available for DMCs running ongoing LA incentive programs." },
      ...
      { question: "Who is Scott Syme and why do DMCs book him specifically?", answer: "Scott Syme is the founder and lead performer of White Rabbit LA. He is magic consultant to America's Got Talent champion Dustin Tavella, a Disney Channel magic consultant on the show Bizaardvark, and a former Compass Beverly Hills luxury real estate professional — a background that translates directly into the white-glove hospitality DMC clients expect. His client roster includes Netflix, Disney, Morgan Stanley, Rolls-Royce, and a long list of Fortune 500 companies. DMCs book him because he shows up personally on every booking — no substitutes — with a corporate-grade booking process and LA-based authority signals that align with the city-themed experiences DMC programs are built around." },
    ],
  },
