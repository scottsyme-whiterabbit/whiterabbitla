        ...
        <div className="max-w-2xl mx-auto px-6 space-y-10">
          <AnimatedSection>
            ...
            <p className="font-sans text-sm text-muted-foreground leading-relaxed mb-3">
              When you interact with White Rabbit Entertainment Productions LLC, d/b/a White Rabbit LA ("White Rabbit LA," "we," "us," or "our"), we may collect information you voluntarily provide, including your name, email address, phone number, event details, and any other information submitted through our contact forms, booking quiz, or newsletter signup.
            </p>
