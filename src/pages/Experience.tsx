    ...
    <main className="pt-20">
      ...
      <section className="relative min-h-[85vh] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroDesertImg} alt="Scott Syme in the desert, White Rabbit luxury magician Los Angeles" className="w-full h-full object-cover" style={{ objectPosition: 'center 25%', filter: 'contrast(1.15) saturate(0.8) brightness(0.92) sepia(0.2)' }} />
