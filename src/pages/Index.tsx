        ...
        <section className="bg-gradient-to-b from-[#F8F5F0] to-[#F0E8D8] py-10">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-4 md:gap-x-8 md:gap-y-5">
              {clients.map((client) => (
                <div key={client.name} className="flex items-center justify-center" style={{ width: (client.name === 'Soho House' || client.name === 'Rivian' || client.name === 'Gravitas Beverly Hills' || client.name === 'The Magic Castle') ? '120px' : '90px', height: (client.name === 'Soho House' || client.name === 'Rivian' || client.name === 'Gravitas Beverly Hills' || client.name === 'The Magic Castle') ? '42px' : '32px' }}>
                  <img
                    src={client.logo}
