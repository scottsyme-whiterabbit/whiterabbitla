...
const CAMPAIGN_DATA: Record<string, { label: string; emoji: string; emails: Array<{ subject: string; day: number; type: string }> }> = {
  corporate_planner: {
    ...
    emoji: "🏢",
    emails: [
      { subject: "nobody remembers last year's holiday party", day: 0, type: "Cold Open" },
      { subject: "Re: nobody remembers last year's holiday party", day: 3, type: "Value Add" },
      { subject: "Q2 event calendar", day: 10, type: "Different Angle" },
  ...
  wedding_planner: {
    ...
    emoji: "💍",
    emails: [
      { subject: "what happens during the 45 minutes your couple is gone", day: 0, type: "Cold Open" },
      { subject: "Re: what happens during the 45 minutes your couple is gone", day: 3, type: "Value Add" },
      { subject: "your vendor list for 2026", day: 10, type: "Different Angle" },
      { subject: "closing the loop", day: 24, type: "Breakup" },
    ],
  },
  country_club: {
    label: "Country Clubs",
    emoji: "⛳",
    emails: [
      { subject: "the member event everyone actually talks about", day: 0, type: "Cold Open" },
      { subject: "Re: the member event everyone actually talks about", day: 3, type: "Value Add" },
      { subject: "holiday party and member event season", day: 10, type: "Different Angle" },
      { subject: "last thing", day: 24, type: "Breakup" },
    ],
  },
  pr_agency: {
    label: "PR & Marketing",
    emoji: "📱",
    emails: [
      { subject: "the moment that makes everyone pull out their phone", day: 0, type: "Cold Open" },
      { subject: "Re: the moment that makes everyone pull out their phone", day: 3, type: "Value Add" },
      { subject: "brand activation idea", day: 10, type: "Different Angle" },
      { subject: "keeping this brief", day: 24, type: "Breakup" },
    ],
  },
  nonprofit: {
    label: "Nonprofits",
    emoji: "❤️",
    emails: [
      { subject: "what happens between cocktails and the paddle raise", day: 0, type: "Cold Open" },
      { subject: "Re: what happens between cocktails and the paddle raise", day: 3, type: "Value Add" },
      { subject: "gala entertainment that pays for itself", day: 10, type: "Different Angle" },
      { subject: "wishing you a great gala season", day: 24, type: "Breakup" },
    ],
  },
  talent_management: {
    label: "Talent Mgmt",
    emoji: "⭐",
    emails: [
      { subject: "entertainment for rooms where everyone's seen everything", day: 0, type: "Cold Open" },
      { subject: "Re: entertainment for rooms where everyone's seen everything", day: 3, type: "Value Add" },
      { subject: "private party season", day: 10, type: "Different Angle" },
      { subject: "keeping this short", day: 24, type: "Breakup" },
    ],
  },
  restaurant: {
    label: "Restaurants",
    emoji: "🍽️",
    emails: [
      { subject: "filling seats on your slowest night", day: 0, type: "Cold Open" },
      { subject: "Re: filling seats on your slowest night", day: 3, type: "Value Add" },
      { subject: "weekly magic residency — how it works", day: 10, type: "Different Angle" },
      { subject: "last note", day: 24, type: "Breakup" },
    ],
  },
};
